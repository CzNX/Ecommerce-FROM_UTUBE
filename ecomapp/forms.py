...
class CustomerRegistrationForm(forms.ModelForm):
    ...
    def clean_username(self):                          #def clean_field_name
...
class ProductForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {                                           #widgets to add stylings to form fields 
            "title": forms.TextInput(attrs={                            #dict form
                "class": "form-control",
...
class PasswordForgotForm(forms.Form):
    ...
    def clean_email(self):      #to validate a single field is to override the method clean_<fieldname>()
        e = self.cleaned_data.get("email")   #cleaned_dat.get for getting entered email
